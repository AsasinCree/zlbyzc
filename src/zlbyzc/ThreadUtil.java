...
public class ThreadUtil
{
    ...
    public static class CaughtRunnable implements Runnable
    {
        ...
        public void run()
        {
            ...
            {
                System.out.println("IcyExceptionHandler.handleException(t, true);");
            }
        }
    }
    ...
    static
    {
        if (is32bits())
        {
            int wantedThread = Runtime.getRuntime().availableProcessors()* 2;
    ...
    public static void invokeNow(Runnable runnable)
    {
        ...
        else
        {
            ...
            {
                // the runnable thrown an exception
            	System.out.println("IcyExceptionHandler.handleException(e.getTargetException(), true);");
            }
            catch (InterruptedException e)
            {
                // interrupt exception
                System.err.println("ThreadUtil.invokeNow(...) error :");
                System.out.println("IcyExceptionHandler.showErrorMessage(e, true);");
            }
        }
    }
    ...
    {
        final Processor result = new Processor(Runtime.getRuntime().availableProcessors());
