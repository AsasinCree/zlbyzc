...
public class FuzzyJDBC_wapper {
	...
	public FuzzyJDBC_wapper(String sIniPath){
		try {
	...
	public static void testInsertAndQuery(){
		try {
			...
			String insertCMD = "insert fuzzy values('南海问题','20000302','一些结论等等','一些结论等等')";
			mysql_.insert(insertCMD);
			
			String queryCMD = "select * from fuzzy";
	...
	public static void  testDatetime(){
		try {
			...
			String insertCMD;	 
			insertCMD = String.format("insert fuzzy values('a1问题','%s','一些结论等等','一些结论等等')", "2000-2-3");mysql_.insert(insertCMD);
			insertCMD = String.format("insert fuzzy values('a2问题','%s','一些结论等等','一些结论等等')", "2000-2-4");mysql_.insert(insertCMD);
			insertCMD = String.format("insert fuzzy values('a3问题','%s','一些结论等等','一些结论等等')", "2001-2-3");mysql_.insert(insertCMD);
			insertCMD = String.format("insert fuzzy values('a4问题','%s','一些结论等等','一些结论等等')", "2010-12-3");mysql_.insert(insertCMD);
			insertCMD = String.format("insert fuzzy values('a5问题','%s','一些结论等等','一些结论等等')", "2003-2-13");mysql_.insert(insertCMD);
			
			//System.out.println(insertCMD);
			//mysql_.insert(insertCMD);
			
			String queryCMD = "select * from fuzzy where fuzzyaim like '%%%问题%%%' and fuzzyargueTime>'20050202' and fuzzyargueTime<'20150302'";
			ResultSet rs = mysql_.query(queryCMD);
