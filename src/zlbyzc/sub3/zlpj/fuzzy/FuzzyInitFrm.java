...
//		comboBoxTaskLocation.setSelectedItem(null);
		...
		textfieldIndexNames.setMinimumSize(new Dimension(100,25));
		textfieldIndexNames.setMaximumSize(new Dimension(150,30));
		textfieldCommentNames.setMinimumSize(new Dimension(100,25));
		textfieldCommentNames.setMaximumSize(new Dimension(150,30));
...
//				comboBoxTaskLocation.setSelectedItem(null);
		...
		buttonexample.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent arg0) {
				textfieldAimName.setText("服装评判");
				textfieldIndexNames.setText("花色 式样 耐穿程度 价格");
