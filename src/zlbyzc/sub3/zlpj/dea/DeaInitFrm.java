...
//		comboBoxTaskLocation.setSelectedItem(null);
		...
		textfieldDeaAimName.setMinimumSize(new Dimension(100,25));
		textfieldDeaAimName.setMaximumSize(new Dimension(150,30));
		textfieldObjectNames.setMinimumSize(new Dimension(100,25));
		textfieldObjectNames.setMaximumSize(new Dimension(150,30));
		textfieldInputNames.setMinimumSize(new Dimension(100,25));
		textfieldInputNames.setMaximumSize(new Dimension(150,30));
		textfieldOutputNames.setMinimumSize(new Dimension(100,25));
		textfieldOutputNames.setMaximumSize(new Dimension(150,30));
			...
			public void mouseClicked(MouseEvent arg0) {
				if(checkInput()){//输入正确
					...
					if(datePickerArgueTime.getModel().getValue() != null)
						time = String.format("%s-%s-%s",datePickerArgueTime.getModel().getYear(), 		
			            		datePickerArgueTime.getModel().getMonth()+1, datePickerArgueTime.getModel().getDay());
					else 
						time =String.format("%s-%s-%s", ca.get(Calendar.YEAR),ca.get(Calendar.MONTH)+1,ca.get(Calendar.DATE));
...
//				comboBoxTaskLocation.setSelectedItem(null);
		...
		buttonexample.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent arg0) {
				textfieldDeaAimName.setText("银行各分理处");
				textfieldObjectNames.setText("分理处1 分理处2 分理处3 分理处4");
				textfieldInputNames.setText("职员数 营业面积");
				textfieldOutputNames.setText("储蓄存款 贷款 中间业务");
//				datePickerArgueTime.getModel().setValue(null);
//				comboBoxTaskLocation.setSelectedItem(null);
			}
		});		
