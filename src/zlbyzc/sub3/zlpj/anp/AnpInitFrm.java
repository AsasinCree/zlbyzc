...
//	private JTextArea paraInfo;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					AnpInitFrm frame = new AnpInitFrm();
...
//		comboBoxTaskLocation.setSelectedItem(null);
		...
		textfieldAimName.setMinimumSize(new Dimension(100,25));
		textfieldAimName.setMaximumSize(new Dimension(150,30));
		textfieldFactorNames.setMinimumSize(new Dimension(100,25));
		textfieldFactorNames.setMaximumSize(new Dimension(150,30));
		textfieldPlanNames.setMinimumSize(new Dimension(100,25));
		textfieldPlanNames.setMaximumSize(new Dimension(150,30));
		...
		buttonconfirm.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				if(checkInput()){//输入正确
					...
					setContentPane(new AnpDataPanel(aim_name,factor_names,plan_names,time));
					revalidate();
					repaint(); 
...
//				comboBoxTaskLocation.setSelectedItem(null);
		...
		buttonexample.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent arg0) {
				textfieldAimName.setText("选车");
				textfieldFactorNames.setText("成本 维修 耐用性");
				textfieldPlanNames.setText("美国车 欧洲车 日本车");
//				datePickerArgueTime.getModel().setValue(null);
//				comboBoxTaskLocation.setSelectedItem(null);
			}
		});
