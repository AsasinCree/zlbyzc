...
public class AnpJDBC_wapper {
	...
	public AnpJDBC_wapper(String sIniPath){
		try {
	...
	public static void testInsertAndQuery(){
		try {
			...
			String insertCMD = "insert anp values('南海问题','20000302','一些结论等等','一些结论等等')";
			mysql_.insert(insertCMD);
			
			String queryCMD = "select * from anp";
	...
	public static void  testDatetime(){
		try {
			...
			String insertCMD;	 
			insertCMD = String.format("insert anp values('a1问题','%s','一些结论等等','一些结论等等')", "2000-2-3");mysql_.insert(insertCMD);
			insertCMD = String.format("insert anp values('a2问题','%s','一些结论等等','一些结论等等')", "2000-2-4");mysql_.insert(insertCMD);
			insertCMD = String.format("insert anp values('a3问题','%s','一些结论等等','一些结论等等')", "2001-2-3");mysql_.insert(insertCMD);
			insertCMD = String.format("insert anp values('a4问题','%s','一些结论等等','一些结论等等')", "2010-12-3");mysql_.insert(insertCMD);
			insertCMD = String.format("insert anp values('a5问题','%s','一些结论等等','一些结论等等')", "2003-2-13");mysql_.insert(insertCMD);
			
			//System.out.println(insertCMD);
			//mysql_.insert(insertCMD);
			
			String queryCMD = "select * from anp where anpaim like '%%%问题%%%' and anpargueTime>'20050202' and anpargueTime<'20150302'";
			ResultSet rs = mysql_.query(queryCMD);
