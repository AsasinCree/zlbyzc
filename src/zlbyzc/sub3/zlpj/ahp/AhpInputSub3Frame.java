...
public class AhpInputSub3Frame extends sub3inFrame implements ActionListener {
	...
	public AhpInputSub3Frame( BasicRibbon _br){
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == buttonConfirm) {
			...
			if(checkInput()){//输入正确
				...
				//this.dispose();
				AhpMatPanel panelAhpMat = new AhpMatPanel(this, aim_name, factor_names, plan_names,BR);
...
//			String[] plans = { "成都", "武汉", "杭州", };	
			...
			//AhpMatPanel ahpMatPanel = new AhpMatPanel(this, aim, factors, plans,BR);
...
//			}
			...
			textfieldAimName.setText("研发新武器");
			textfieldFactorNames.setText("杀伤力  射程  资金投入  研发周期  技术难度");
			textfieldPlanNames.setText("武器甲  武器乙  武器丙");
			try {
				this.setMaximum(true);
			} catch (PropertyVetoException e1) {
				e1.printStackTrace();
