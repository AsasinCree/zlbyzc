...
public class gamematrixquery extends sub3inFrame {
	...
	public gamematrixquery() {
		...
		gridBagLayout.rowHeights = new int[]{10, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25,25, 25, 25,25,25,25};
		...
		btnGameNameSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try 
				{
					...
					String sql = "select * from tb_game_tree where game_tree_type =1";
		...
		add(sp_gamematrix_query, gbc_tb_gamematrix_query);
		...
		gbc_tb_Gametree_profit.gridy = 13;
