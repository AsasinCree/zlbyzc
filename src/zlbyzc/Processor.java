...
public class Processor extends ThreadPoolExecutor
{
    ...
    public static final int DEFAULT_MAX_PROCESSING =   Runtime.getRuntime().availableProcessors();;
    ...
    protected class FutureTaskAdapter<T> extends FutureTask<T>
    {
        ...
        protected void done()
        {
            ...
            if (handleException)
            {
                ...
                {
                    System.out.println("IcyExceptionHandler.handleException(e.getCause(), true);");
                }
            }
        }
    }
