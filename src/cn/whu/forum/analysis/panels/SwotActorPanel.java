...
public class SwotActorPanel extends JPanel implements ActionListener {
	 ...
	 *            参与者实例
	 */
	public SwotActorPanel(SwotActor swotActor) {
	...
	public void initializeComponent() {
		...
		labelAdvantage.setFont(StaticConfig.FONT_EDITVIEW_PROPERTY);
		labelChance = new JLabel("机会");
		labelChance.setFont(StaticConfig.FONT_EDITVIEW_PROPERTY);
		labelDisadvantage = new JLabel("劣势");
		labelDisadvantage.setFont(StaticConfig.FONT_EDITVIEW_PROPERTY);
		labelThreat = new JLabel("威胁");
		labelThreat.setFont(StaticConfig.FONT_EDITVIEW_PROPERTY);
		labelActorName = new JLabel(swotActor.getActorName());
		labelActorName.setFont(StaticConfig.FONT_EDITVIEW_ACTORNAME);
		...
		popmenuItemAddProperty.setFont(StaticConfig.FONT_TABLE_RIGHT_CLICK_MENU);
		popmenuItemDeleteProperty = new JMenuItem("删除");
		popmenuItemDeleteProperty.setFont(StaticConfig.FONT_TABLE_RIGHT_CLICK_MENU);
		popmenuItemModifyProperty = new JMenuItem("修改");
		popmenuItemModifyProperty.setFont(StaticConfig.FONT_TABLE_RIGHT_CLICK_MENU);
	...
	public JTable initializeTable(final String tableType) {
		...
		dtm.setDataVector(new Object[][] { { "", "", -1 } }, new Object[] { "编号", "内容", "PropertyID" });
		...
		// 第三列为隐藏列，存储属性ID，便于deleteProperty。获得remove掉的列的data必须使用TableModel
	...
	public void addProperty() {
		...
		lableContentInAddProperty.setFont(StaticConfig.FONT_DIALOG_LABEL);

		textareaContentInAddProperty = new JTextArea(5, 5);
		textareaContentInAddProperty.setFont(StaticConfig.FONT_DIALOG_TEXTAREA);
		...
		buttonConfirmInAddProperty.setFont(StaticConfig.FONT_DIALOG_BUTTON);
		buttonCancelInAddProperty = new JButton("取消");
		buttonCancelInAddProperty.setFont(StaticConfig.FONT_DIALOG_BUTTON);
	...
	public void modifyProperty() {
		...
		panelLaytextAreaContentInModifyProperty
				.setLayout(new BoxLayout(panelLaytextAreaContentInModifyProperty, BoxLayout.X_AXIS));
		...
		lablePropertyContentInModifyProperty.setFont(StaticConfig.FONT_DIALOG_LABEL);

		textAreaPropertyContentInModifyProperty = new JTextArea(5, 5);
		textAreaPropertyContentInModifyProperty.setFont(StaticConfig.FONT_DIALOG_TEXTAREA);
		...
		buttonConfirmInModifyProperty.setFont(StaticConfig.FONT_DIALOG_BUTTON);
		buttonCancelInModifyProperty = new JButton("取消");
		buttonCancelInModifyProperty.setFont(StaticConfig.FONT_DIALOG_BUTTON);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == popmenuItemAddProperty) {
			...
			if (dtm.getValueAt(0, 0) == "") {
				...
				dtm.addRow(new Object[] { dtm.getRowCount() + 1, swotActorProperty.getPropertyContent(),
						swotActorProperty.getPropertyID() });
			}
