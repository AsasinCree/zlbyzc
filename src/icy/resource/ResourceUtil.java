...
{
    // image and icon path
    public static final String ICON_PATH = "img/icons/";
...
//        ImageUtil.drawTextTopRight(result, Integer.toString(number), 26, true, Color.black);
//
//        return result;
//    }
//
